...
import {AddressInfoDarwinia,AddressInfo, AddressRow, Button, Card, Icon} from '@polkadot/ui-app';
...
class AccountDarwinia extends React.PureComponent<Props> {
  ...
  private transferCB = (type: string):void => {
    this.setState({
      type: type
    },() => {
      this.toggleTransfer();
  ...
  private renderModals() {
    const {address} = this.props;
    const {isBackupOpen, isForgetOpen, isPasswordOpen, isTransferOpen,type} = this.state;
...
export default translate(AccountDarwinia);
