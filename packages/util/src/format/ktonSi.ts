...
export const SI: Array<SiDef> = [
  ...
  { power: 0, value: '-', text: 'KTON' }, // position 8
...
// export const CUSTOMIZESI: Array<SiDef> = [
//   { power: 0, value: 'kton', text: 'KTON' }, 
// ]
...
export function findSi (type: string): SiDef {
  ...
  // for (let i = 0; i < CUSTOMIZESI.length; i++) {
  //   if (CUSTOMIZESI[i].value === type) {
  //     return CUSTOMIZESI[i];
  //   }
  // }
